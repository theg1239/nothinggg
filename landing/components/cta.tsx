  ...
  return (
    <section className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <div className="absolute top-1/3 left-1/4 w-1/2 h-1/2 bg-teal-500/10 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-1/3 right-1/4 w-1/2 h-1/2 bg-blue-500/10 rounded-full blur-[100px]"></div>
      </div>
      
      <div className="container px-4 md:px-6 mx-auto max-w-6xl">
        <div className="relative bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl border border-gray-800 p-8 md:p-12 shadow-2xl">
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-500 to-blue-500 rounded-t-3xl"></div>
